...
and {\em (vi)} a comparison with prior forms of slicing and type debugging (\S\ref{sec:related-work}) and applications to set-theoretic and occurrence typing (\S\ref{sec:set-theoretic}).
