...
and {\em (vi)} a comparison with prior forms of slicing (\S\ref{sec:related-work}) and applications to set-theoretic and occurrence typing (\S\ref{sec:set-theoretic}).
...
The core calculus and metatheory are mechanised in Agda and all implementations are available in the supplemental material.
