...
marked) context-classification rules, and the marked-context metatheory.
...
\inference[\synr{Const}]{}{\tmrule{*}{*}{\latticetop}{*}{*}{\emptyset}}
...
Marked context classification (introduced in the Error Marking section of the main
