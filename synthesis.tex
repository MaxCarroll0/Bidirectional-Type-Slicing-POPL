...
\begin{center}
\fullslice{x : \sli{\mathbf{*} \funarr \mathbf{*}}}{\sli{\mathbf{if}}\;\mathbf{true}\;\sli{\mathbf{then}\;x\;\mathbf{else}}\;y}
\quad$\xrightarrow{\upsilon' \sqsubseteq \upsilon}$\quad
\fullslice{y : \mathbf{*}\,\sli{\funarr \mathbf{*}}}{\sli{\mathbf{if}}\;\mathbf{true}\;\sli{\mathbf{then}}\;x\;\sli{\mathbf{else}\;y}}
\end{center}
...
\centering
\begin{tikzcd}[column sep=large, row sep=large]
\rho_1 \arrow[r, "\sqsubseteq"] \arrow[d, "\synmode"'] & {\color{induced} \rho^{\sqcup}} \arrow[d, "\synmode"] & \rho_2 \arrow[l, "\sqsupseteq"'] \arrow[d, "\synmode"] \\
