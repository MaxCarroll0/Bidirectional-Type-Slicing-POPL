...
\[
  \inference[$s\iota_1$]
    {\ctxclass{\C}{{\color{BrickRed}\Uparrow}\;\tau}{\Delta';\,\Gamma'}{m}}
    {\ctxclass{\iota_1\,\C}{{\color{BrickRed}\Uparrow}\;\tau + \gap}{\Delta';\,\Gamma'}{m}}
\]
\[
  \inference[$s\iota_2$]
    {\ctxclass{\C}{{\color{BrickRed}\Uparrow}\;\tau}{\Delta';\,\Gamma'}{m}}
    {\ctxclass{\iota_2\,\C}{{\color{BrickRed}\Uparrow}\;\gap + \tau}{\Delta';\,\Gamma'}{m}}
\]
\[
  \inference[$a\iota_1$]
...
\[
  \inference[$ms\iota_1$]
    {\mctxclass{C}{\chk C}{{\color{BrickRed}\Uparrow}\,\tau}{\Delta';\,\Gamma'}{m}}
    {\mctxclass{\iota_1\,C}{\iota_1\,\chk C}{{\color{BrickRed}\Uparrow}\,\tau + \gap}{\Delta';\,\Gamma'}{m}}
\]
\[
  \inference[$ms\iota_2$]
    {\mctxclass{C}{\chk C}{{\color{BrickRed}\Uparrow}\,\tau}{\Delta';\,\Gamma'}{m}}
    {\mctxclass{\iota_2\,C}{\iota_2\,\chk C}{{\color{BrickRed}\Uparrow}\,\gap + \tau}{\Delta';\,\Gamma'}{m}}
\]
\[
  \inference[$ma\iota_1$]
    {\tau \sqcup \gap + \gap \equiv \tau_1 + \tau_2 &
