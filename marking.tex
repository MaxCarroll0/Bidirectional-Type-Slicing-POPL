...
This section formally applies type slicing to static error squiggles as in \cref{fig:parse-digit-slices} (\S\ref{sec:slicing-by-example}). It demonstrates that we can not only use this calculus to ``explain types'' in well-typed programs, but also effectively ``explain type errors'' in ill-typed programs.
