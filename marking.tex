...
\]
Marking would ordinarily report the error $\markincon{\texttt{Bool} \times \texttt{Bool}}{* \funarr *}$ with the entire term boxed. However, in reality, only the outermost type constructors are actually causing the (initial) type inconsistency, and type slicing allows query refinements of the full types. In full:
