...
\item Pick queries to explore the error. For type-inconsistency marks \textit{both} the synthesis and analysis slices exist (two context typings exist from step 1). From these, you can query \textit{only} the inconsistent parts. For shape errors, simply query just the outermost shape of the synthesised type; mode-limitation errors are analogous on the analysis side.
\end{enumerate}
