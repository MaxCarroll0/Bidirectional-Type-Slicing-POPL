...
The formal mathematics of these two concepts are introduced in \cref{sec:synthesis,sec:analysis} explored upon a core calculus specified in \cref{sec:core-calculus} which includes sum types, products, and explicit polymorphism.
